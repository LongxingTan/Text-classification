...
def main():
    ...
    model_fn=model_fn_builder(bert_config=bert_config,init_checkpoint=config.init_checkpoint,
...
'''
    train_features=create_features(train_examples, label_list,config.max_seq_length,tokenizer)
    input_ids=[f.input_ids for f in train_features]
    input_mask=[f.input_mask for f in train_features]
    segment_ids=[f.segment_ids for f in train_features]
    label_ids=[f.label_id for f in train_features]
